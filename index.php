...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <section class="bg-dark-30 home-section home-parallax home-fade home-full-height showcase-index" data-background="assets/images/animeIndex.png">
        <div class="titan-caption">
          <div class="caption-content">
            <div class="font-alt mb-30 titan-title-size-1">Your one stop shop..</div>
            <div class="font-alt mb-40 titan-title-size-4">for everything ANIME</div>
          </div>
        </div>
      </section>
    ...
    <?php include 'navigation/scripts.html'?>
  </body>
  <?php include 'navigation/footer.html'?>
</html>